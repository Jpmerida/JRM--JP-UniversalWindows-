...
Public Class CrystalReport_OR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JRM__JP_UniversalWindows_.CrystalReport_OR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport_OR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport_OR = New CrystalReport_OR()
        rpt.Site = Me.Site
        Return rpt
    End Function
