...
Public Class Form_Report
    Private Sub Form_Report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim report2 As New CrystalReport1
        report2.Load()
        ...
        Dim report3 As New CrystalReport1
        report3.Load()
        ...
        Dim report4 As New CrystalReport1
        report4.Load()
        ...
        Dim report5 As New CrystalReport1
        report5.Load()
        ...
        Dim report6 As New CrystalReport1
        report6.Load()
        ...
        Dim report7 As New CrystalReport1
        report7.Load()
        ...
        Dim report8 As New CrystalReport1
        report8.Load()
